      ...
      <div class="container-fluid">
        ...
        <form class="kainos-search-group" role="search">
          <div class="form-group">
            ...
            <input type="text" class="form-control input-sm kainos-search" placeholder="Search" value="really really long query that wrappps sjkhaskjhasdas kjhasdasd query">
